...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Fabricante`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Fabricante` (
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Produto`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Produto` (
  ...
  CONSTRAINT `fk_Produto_Fabricante1`
    ...
    REFERENCES `db_ra165684`.`Fabricante` (`idFabricante` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Categoria`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Categoria` (
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Ingrediente`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Ingrediente` (
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Pais`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Pais` (
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Paises_Vendidos`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Paises_Vendidos` (
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Produto_has_Ingrediente`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Produto_has_Ingrediente` (
  `Produto_Cod_barras` VARCHAR(12) NOT NULL ,
  ...
  CONSTRAINT `fk_Produto_has_Ingrediente_Ingrediente1`
    ...
    REFERENCES `db_ra165684`.`Ingrediente` (`idIngrediente` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Paises_Fabricados`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Paises_Fabricados` (
  `Produto_Cod_barras` VARCHAR(12) NOT NULL ,
  `Pais_nomePais` VARCHAR(45) NOT NULL ,
  PRIMARY KEY (`Produto_Cod_barras`, `Pais_nomePais`) ,
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Embalagem`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Embalagem` (
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Categoria_has_Produto`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Categoria_has_Produto` (
  ...
  CONSTRAINT `fk_Categoria_has_Produto_Categoria1`
    ...
    REFERENCES `db_ra165684`.`Categoria` (`idCategoria` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Produto_has_Embalagem`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Produto_has_Embalagem` (
  `Produto_Cod_barras` VARCHAR(12) NOT NULL ,
  ...
  CONSTRAINT `fk_Produto_has_Embalagem_Embalagem1`
    ...
    REFERENCES `db_ra165684`.`Embalagem` (`Nome_embalagem` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Premio`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Premio` (
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Produto_has_Premio`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Produto_has_Premio` (
  ...
  CONSTRAINT `fk_Premio_has_Produto_Premio1`
    ...
    REFERENCES `db_ra165684`.`Premio` (`Nome_Premio` )
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Caracteristica`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Caracteristica` (
...
-- -----------------------------------------------------
-- Table `db_ra165684`.`Produto_has_Caracteristica`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `db_ra165684`.`Produto_has_Caracteristica` (
  ...
  CONSTRAINT `fk_Produto_has_Caracteristica_Carac`
    ...
    REFERENCES `db_ra165684`.`Caracteristica` (`Nome_Caracteristica` )
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
